namespace GraphVisualization
{
    partial class GraphForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnFloydWarshall = new Button(); // Добавлено
            txtX = new TextBox();
            txtY = new TextBox();
            ...
            // btnFloydWarshall
            // 
            btnFloydWarshall.Location = new Point(865, 643); // Позиция кнопки Флойда
            btnFloydWarshall.Margin = new Padding(4, 5, 4, 5);
            btnFloydWarshall.Name = "btnFloydWarshall";
            btnFloydWarshall.Size = new Size(133, 35);
            btnFloydWarshall.TabIndex = 21;
            btnFloydWarshall.Text = "Флойд";
            btnFloydWarshall.UseVisualStyleBackColor = true;
            btnFloydWarshall.Click += btnFloydWarshall_Click; // Обработчик события
            // 
            // txtX
            // 
            ...
            Controls.Add(txtY);
            Controls.Add(txtX);
            Controls.Add(btnFloydWarshall); // Добавлено
        ...
        private System.Windows.Forms.Button btnFloydWarshall; // Добавлено
